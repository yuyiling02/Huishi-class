...
const COMMAND_PATTERNS: [RegExp, string, (ctrl: ControlRefs) => void][] = [
  [/再?放?大一点|大一点|大些|大一些|靠近|拉近|近一点|近一些|放大/, 'zoom_in', (c) => { c.zoomSpeed = 0.13; setTimeout(() => { c.zoomSpeed = 0; }, 1500); }],
  [/再?缩?小一点|小一点|小些|小一些|远离|拉远|远一点|远一些|缩小/, 'zoom_out', (c) => { c.zoomSpeed = -0.13; setTimeout(() => { c.zoomSpeed = 0; }, 1500); }],
